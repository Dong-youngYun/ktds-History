			...
			<jsp:include page="../include/content.jsp" />
							...
							<c:choose>
								<c:when test="${not empty mbrList}">
									<c:forEach items="${mbrList}"
												var="mbr"
												varStatus="index">
										<!-- JSON으로 데이터를 받아온다 DB에서 받아와도 되지만 딜레이 시간이 길다. -->
				...
				<div class="grid-detail">
					<form id="detail_form">
						...
						<div class="input-group inline">
							<label for="lgnTryCnt" style="width: 180px;">로그인 실패 횟수</label><input type="text" id="lgnTryCnt" name="lgnTryCnt" value=""/>
						</div>
						<div class="input-group inline">
							<label for="lgnBlockYn" style="width: 180px;">접속 제한 여부</label><input type="checkbox" id="lgnBlockYn" name="lgnBlockYn" value="Y"/>
						</div>
						<div class="input-group inline">
							<label for="lstLgnFailDt" style="width: 180px;">로그인 실패 날짜</label><input type="text" id="lstLgnFailDt" disabled value=""/>
						</div>
						<div class="input-group inline">
